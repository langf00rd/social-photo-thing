...
export const PRESETS: LayoutPreset[] = [
  ...
  },
  {
    ...
    slots: 2,
    divisions: [
      { x: 0, y: 0, width: 0.618, height: 1 }, // Main image (≈ 61.8%)
      { x: 0.618, y: 0, width: 0.382, height: 1 }, // Secondary column
    ],
  },
  {
    id: "magazine-spread",
    ...
    slots: 3,
    divisions: [
      { x: 0, y: 0, width: 0.65, height: 0.65 }, // Main image
      { x: 0.65, y: 0, width: 0.35, height: 0.5 }, // Side vertical
      { x: 0, y: 0.65, width: 1, height: 0.35 }, // Bottom banner
    ],
  },
  {
    id: "polaroid-stack",
  ...
  },
  {
    ...
    divisions: [
      ...
      { x: 0.33, y: 0.33, width: 0.34, height: 0.34 }, // Center image
